...
bool PlayerLoginInfo::LoginBot()
{
    ...
    if (ObjectAccessor::FindPlayerNotInWorld(ObjectGuid(HIGHGUID_PLAYER, guid)))
    {
        loginState = LoginState::BOT_ONLINE;
        return false;
    }
    ...
    Player* player = ObjectAccessor::FindPlayerNotInWorld(ObjectGuid(HIGHGUID_PLAYER, guid));
