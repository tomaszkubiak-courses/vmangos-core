    ...
    public:
        ...
        virtual bool isUseful() override
        {
            ...
            if (isTank)
            {
                ...
                if ((bloodThirst && bot->IsSpellReady(sSpellMgr.GetSpellEntry(bloodThirst))) ||
                    (mortalStrike && bot->IsSpellReady(sSpellMgr.GetSpellEntry(mortalStrike))) ||
                    (shieldSlam && bot->IsSpellReady(sSpellMgr.GetSpellEntry(shieldSlam))))
                {
                    return false;
                }
            }
