...
namespace ai
{
    ...
    public:
        virtual bool Execute(Event& event) override
        {
            ...
            packet << uint8(0);
            bot->GetSession()->BotHandleRepopRequestOpcode(packet);
    ...
    public:
        virtual bool Execute(Event& event) override
        {
            ...
            bool useHomebindOverride = bot->GetRace() == RACE_GOBLIN;
            ...
            if (defaultPlayerInfo)
            {
                ...
                bot->TeleportTo(defaultPlayerInfo->mapId, defaultPlayerInfo->positionX, defaultPlayerInfo->positionY, defaultPlayerInfo->positionZ, defaultPlayerInfo->o);
                if (IsRealPlayer(bot))
                    bot->SendHeartBeat();
            }
            else
    ...
    public:
        bool Execute(Event& event) override
        {
            ...
            bot->GetSession()->BotHandleSelfResOpcode(packet);
            return true;
        }
