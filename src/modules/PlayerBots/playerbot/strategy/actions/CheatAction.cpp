...
void CheatAction::AddCheat(BotCheatMask cheatMask)
{
    ...
    case BotCheatMask::attackspeed:
        ...
        bot->CastCustomSpell(bot, SPELL_MOD_MELEE_HASTE, amount, amount, {}, TRIGGERED_OLD_TRIGGERED);
        bot->RemoveAurasDueToSpell(SPELL_MOD_RANGE_HASTE);
        bot->CastCustomSpell(bot, SPELL_MOD_RANGE_HASTE, amount, amount, {}, TRIGGERED_OLD_TRIGGERED);
        bot->RemoveAurasDueToSpell(SPELL_MOD_SPELL_HASTE);
        bot->CastCustomSpell(bot, SPELL_MOD_SPELL_HASTE, amount, amount, {}, TRIGGERED_OLD_TRIGGERED);
