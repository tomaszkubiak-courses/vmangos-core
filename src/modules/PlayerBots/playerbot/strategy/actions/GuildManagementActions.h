...
namespace ai
{
    ...
    protected:
        virtual void SendPacket(WorldPacket data, Event event) override { bot->GetSession()->BotHandleGuildInviteOpcode(data); };
    ...
    protected:
        ...
        virtual void SendPacket(WorldPacket data, Event event) override { if(GetPlayer(event)) GetPlayer(event)->GetSession()->BotHandleGuildInviteOpcode(data); };
    ...
    protected:
        virtual void SendPacket(WorldPacket data, Event event) override { bot->GetSession()->BotHandleGuildPromoteOpcode(data); };
    ...
    protected:
        virtual void SendPacket(WorldPacket data, Event event) override { bot->GetSession()->BotHandleGuildDemoteOpcode(data); };
    ...
    protected:
        virtual void SendPacket(WorldPacket data, Event event) override { bot->GetSession()->BotHandleGuildLeaderOpcode(data); };
        virtual bool PlayerIsValid(Player* member) override { return member->GetGuildId() == bot->GetGuildId() && GetRankId(bot) < GetRankId(member) - 1; };
    };
    ...
    protected:
        virtual void SendPacket(WorldPacket data, Event event) override { bot->GetSession()->BotHandleGuildRemoveOpcode(data); };
        virtual bool PlayerIsValid(Player* member) override { return member->GetGuildId() == bot->GetGuildId() && GetRankId(bot) < GetRankId(member); };
    };
