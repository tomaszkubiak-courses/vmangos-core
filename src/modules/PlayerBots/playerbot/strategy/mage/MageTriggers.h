...
namespace ai
{
    ...
    public:
        ...
        virtual bool IsActive() override
        {
            return !bot->IsSpellReady(sSpellMgr.GetSpellEntry(133))      //fireball
                && !bot->IsSpellReady(sSpellMgr.GetSpellEntry(2948));    //scorch
        }
    };
    ...
    public:
        ...
        virtual bool IsActive() override
        {
            return !bot->IsSpellReady(sSpellMgr.GetSpellEntry(12472))    //icy veins on cooldown
                && bot->IsSpellReady(sSpellMgr.GetSpellEntry(11958));    //cold snap not on cooldown
        }
    };
